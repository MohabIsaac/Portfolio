          ...
          <div style={{ marginTop: 32 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                { Icon: LinkedinIcon, label: "LINKEDIN", sub: "in/MohabIsaac", color: "#0a66c2", href: "https://www.linkedin.com/in/MohabIsaac" },
                { Icon: YoutubeIcon, label: "YOUTUBE", sub: "@Ozul", color: "#ff0000", href: "https://www.youtube.com/@Ozul" },
                { label: "DISCORD", sub: "ozul1", color: C.violet, glyph: "⚡", href: "#" },
